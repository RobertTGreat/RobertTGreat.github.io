...
export default function FontSwitcher() {
  ...
  return (
    <div className="fixed top-3 right-3 sm:top-6 sm:right-6 z-[50] flex items-center gap-1 sm:gap-1.5 p-1 rounded-xl bg-black/80 border border-white/10 backdrop-blur-md shadow-2xl transition-all">
      <div className="flex items-center gap-1 px-1.5 sm:px-2 text-white/40 text-[10px] sm:text-xs font-mono border-r border-white/10 pr-2">
      ...
      <button
        ...
        className={`px-2 sm:px-2.5 py-0.5 sm:py-1 text-[10px] sm:text-[11px] font-mono rounded-lg transition-colors cursor-pointer ${
          font === 'default'
